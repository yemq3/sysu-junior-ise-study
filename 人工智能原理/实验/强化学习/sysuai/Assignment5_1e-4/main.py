...
for e in range(EPISODES):
    ...
    while not done:
        ...
        if frame % 50000 == 0:
            ...
            pylab.savefig("/home/sysuai/workspace/17363092/Assignment5_1e-4/save_graph/breakout_dqn_noop.png")
        ...
        if done:
            ...
            if mean_evaluation_reward > save_threshold:
                file_path = "/home/sysuai/workspace/17363092/Assignment5_1e-4/save_model/breakout_dqn_noop_{}".format(int(mean_evaluation_reward))
