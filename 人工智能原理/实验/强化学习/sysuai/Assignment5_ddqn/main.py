...
for e in range(EPISODES):
    ...
    while not done:
        ...
        if frame % 50000 == 0:
            ...
            pylab.savefig("/home/sysuai/workspace/17363092/Assignment5_ddqn/save_graph/breakout_ddqn.png")
        ...
        if done:
            ...
            if mean_evaluation_reward > save_threshold:
                file_path = "/home/sysuai/workspace/17363092/Assignment5_ddqn/save_model/breakout_ddqn_{}".format(int(mean_evaluation_reward))
