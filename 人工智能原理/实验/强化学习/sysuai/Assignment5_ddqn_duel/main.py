...
for e in range(EPISODES):
    ...
    while not done:
        ...
        if frame % 50000 == 0:
            ...
            pylab.savefig("/home/sysuai/workspace/17363092/Assignment5_ddqn_duel/save_graph/breakout_ddqn_fuck.png")
        ...
        if done:
            ...
            if mean_evaluation_reward > save_threshold:
                file_path = "/home/sysuai/workspace/17363092/Assignment5_ddqn_duel/save_model/breakout_ddqn_duel_{}".format(int(mean_evaluation_reward))
